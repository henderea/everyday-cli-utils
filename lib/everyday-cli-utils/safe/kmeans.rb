...
module EverydayCliUtils
  module KmeansUtil
    class << self
      ...
      def f_test2_calc(clusters, i, means, uv)
        tmp = 0.0
      ...
      def get_clusters(collection, means)
  ...
  module Kmeans
    class << self
      ...
      def nmeans_setup_2(collection, avg, cnt, ks1)
      ...
      def run_nmean(collection, avg, cnt, ft, ft2, k, ks)
        kso  = ks
        fto  = ft
        fto2 = ft2
      ...
      def run_nmeans(avg, cnt, collection, ft, ft1, ft2, ks, ks1, max_k, threshold)
      ...
      def nmeans(collection, max_k = 10, threshold = 0.05)
      ...
      def outliers(collection, sensitivity = 0.5, k = nil)
